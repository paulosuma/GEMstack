#Adapted from https://github.com/enginBozkurt/Error-State-Extended-Kalman-Filter/blob/master/es_ekf.py
...
from ...mathutils.rotations import Quaternion, skew_symmetric
...
#TODO, add constant to calibration file
gt = data['gt'] #we don't have gt as ground truth
imu_f = data['imu_f']
imu_w = data['imu_w']
gnss = data['gnss']
lidar = data['lidar']   #pass, delete it
