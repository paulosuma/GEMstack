...
from utils.model_lib import model_dict
from utils import prepare_seed, print_log, mkdir_if_missing
from utils.dataloader_improved import data_generator
...
class PedestrianTrajPrediction(Component):
    ...
    # Do NOT use until we get everything else
    ...
    def run_model(self, data: np.ndarray):
        split = 'test'
    ...
    def update(self, past_agent_states) -> List[Dict[List[AgentState]]]:
        ...
        sample_model_3D, valid_ids, frame = self.run_model(data)
