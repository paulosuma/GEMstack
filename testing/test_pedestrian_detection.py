...
if __name__=='__main__':
    ...
    zed_image = cv2.imread(os.path.join(abs_path, f'../data/hw3/step1/color{data_idx}.png'))
    depth = cv2.imread(os.path.join(abs_path, f'../data/hw3/step1/depth{data_idx}.tif'), cv2.IMREAD_UNCHANGED)
